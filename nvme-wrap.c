...
#include "subprojects/libnvme/src/libnvme-mi.h"
#else
#include <libnvme.h>
...
NVME_WRAP_API int nvme_cli_features_power_mgmt(struct nvme_dev *dev, __u8 ps, __u8 wh, bool save, __u32 *result)
{
...
NVME_WRAP_API int nvme_cli_sanitize_nvm(struct nvme_dev *dev, struct nvme_sanitize_nvm_args *args)
{
...
NVME_WRAP_API int nvme_cli_get_log_page(struct nvme_dev *dev, __u32 xfer_len,
